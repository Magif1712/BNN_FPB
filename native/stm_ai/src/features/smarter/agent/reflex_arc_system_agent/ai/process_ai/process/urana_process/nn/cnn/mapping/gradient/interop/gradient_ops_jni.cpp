...
JNIEXPORT void JNICALL JNI_METHOD(features_smarter_agent_reflex_1arc_1system_1agent_ai_process_1ai_process_urana_1process_nn_cnn_mapping_training, CnnTrainingOpsNative, _1cnnBackwardLayer)(
    JNIEnv *env,
    jclass clazz,
