package com.github.magif1712.smarter_touhou_maids.features.smarter.possession.client.input;
...
public class PossessionInputHandler {
    ...
    public static void onClientTick(TickEvent.ClientTickEvent event) {
        ...
        if (target == null) {
            if (mc.player != null) {
                mc.player.sendSystemMessage(Component.translatable("msg.smarter_touhou_maids.possession.no_maid"));
            }
            return;
        }

        if (!PossessionManager.INSTANCE.isPossessionEnabled(target)) {
            if (mc.player != null) {
                mc.player.sendSystemMessage(Component.translatable("msg.smarter_touhou_maids.possession.not_enabled"));
            }
            return;
        }
