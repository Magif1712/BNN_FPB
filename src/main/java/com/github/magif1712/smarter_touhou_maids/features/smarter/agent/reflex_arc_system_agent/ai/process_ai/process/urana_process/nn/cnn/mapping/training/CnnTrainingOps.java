package com.github.magif1712.smarter_touhou_maids.features.smarter.agent.reflex_arc_system_agent.ai.process_ai.process.urana_process.nn.cnn.mapping.training;
 ...
 * <p>
 * 重构：{@code y}（= {@code ys[i]}）替代原 {@code trace.y}——StoreTrace 下 trace_y 即 ys[i]，
 * 一份写入两方消费，零额外缓冲（设计原则第5条）。
 * <p>
